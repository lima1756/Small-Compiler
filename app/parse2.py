...
class Symbol:
    ...
    def __init__(self, symbol_type=None, value=None, declaration_pos=None, init_pos=None):
        self.symbol_type = symbol_type
        self.value = value
        self.declaration_pos = declaration_pos
        self.init_pos = init_pos
        self.post_name = "t"+Symbol.counter
        Symbol.counter += 1
    ...
    def p_assign_op(self, p):
        ...
        if p[1] not in self.symbol_table:
            self.errors.append("Variable %s hasn't been declared and is being used at line %d".format(
                p[1], p.lexer.lineno))
        elif p[3][0] == 'id' and p[3][1] not in self.symbol_table:
            self.errors.append("Variable %s hasn't been declared and is being used at line %d".format(
