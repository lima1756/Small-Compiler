...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','test.py',59),
  ('statement -> expression','statement',1,'p_statement_expr','test.py',64),
  ('expression -> expression + expression','expression',3,'p_expression_binop','test.py',69),
  ('expression -> expression - expression','expression',3,'p_expression_binop','test.py',70),
  ('expression -> expression * expression','expression',3,'p_expression_binop','test.py',71),
  ('expression -> expression / expression','expression',3,'p_expression_binop','test.py',72),
  ('expression -> - expression','expression',2,'p_expression_uminus','test.py',84),
  ('expression -> ( expression )','expression',3,'p_expression_group','test.py',89),
  ('expression -> NUMBER','expression',1,'p_expression_number','test.py',94),
  ('expression -> NAME','expression',1,'p_expression_name','test.py',99),
]
